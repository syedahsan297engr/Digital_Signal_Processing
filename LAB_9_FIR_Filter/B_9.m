%{
Let h = [-4,1,-1,-2,5,6,5,-2,-1,1,-4]; Determine the amplitude response and the 
locations of the zeros of H(z).
Since M = 11, which is odd, and since h(n) is symmetric about α = (11-1)/2 = 5, this is a Type-1 linear 
phase FIR filter
%}
